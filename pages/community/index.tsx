    ...
    <Layout title="동네생활" hasTabBar>
      {[1, 1, 1, 1, 1, 1, 1].map((_, i) => (
        ...
        className="flex flex-col items-start">
          ...
          <div className="mt-5 flex items-center justify-between w-full font-medium text-gray-500 text-xs">
            <span>니꼬</span>
            <span>18시간 전</span>
          </div>
          <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[2px] w-full text-sm">
