        ...
        <div className="py-10 px-4 space-y-10">
            <div className="flex items-center space-x-2 w-full">
                ...
                <div className="flex flex-col">
                    <span className="block font-bold">Steve Jebs</span>
                    <span className="text-sm">Edit profile &rarr;</span>
                </div>
            </div>
            <div className="flex justify-around">
                <div className="flex flex-col space-y-1 items-center">
                    <div className="flex justify-center items-center bg-orange-500 text-white rounded-full p-4">
                        <svg
                            className="w-6 h-6"
                            fill="none"
                            stroke="currentColor"
            ...
            <div className="space-y-4">
                <div className="flex space-x-2">
                    ...
                    <div className="flex flex-col justify-center">
                        <h4 className="text-xs block">니꼬</h4>
                        <div className="flex">
                            <svg
